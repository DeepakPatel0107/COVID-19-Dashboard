		...
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
					<h2 class="title-head">Login <span>Users Account</span></h2>
					...
					<div class="row placeani">
						...
						<div class="col-lg-12">
							<div class="form-group form-forget">
                                                            ...
                                                            <a href="forget-password.jsp" class="ml-auto fa fa-question"> Forgot Password?</a>
							</div>
						</div>
                                            <div class="col-lg-12">
							<div class="form-group form-forget">
								
                                                            <a href="register.jsp" class="ml-auto fa fa-users"> Register Now</a>
							</div>
						</div>
                                             <div class="col-lg-12">
							<div class="form-group form-forget">
								
                                                            <a href="index_1.jsp" class="ml-auto fa fa-user"> Admin Login</a>
							</div>
						</div>
						<div class="col-lg-12 m-b30">
                                                    <input  type="button" value="Login" class="btn button-md" onclick="ValidateAndLogin()" />
						</div>
