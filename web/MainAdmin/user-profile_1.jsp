...
<html lang="en">
 ...
 <div class="ttr-header-right ttr-with-seperator">
    ...
    String query33 = "Select * from userdetails where email='"+email+"'";
             ...
             const email = urlParams.get('email');
              ...
              }else
              {
                $.ajax({
                        ...
                        data: {name: name, father: father, mother: mother, address: address, city: city, state: state, pincode: pincode,dob: dob, mobile:mobile, email:email},
                        success: function (msg) {
                            $("#error").empty();
                            $("#error").append(msg);
